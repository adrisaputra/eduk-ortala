									...
									<table class="table table-bordered table-hover mb-4">
										...
										@foreach($education_history as $v)
											<tr onclick="selectRow(this)">
												...
												<td id="education_history-{{ $v->id }}" onClick="getEmployee(this.id)">{{ $v->rank }}</td>
												<td id="education_history-{{ $v->id }}" onClick="getEmployee(this.id)">{{ $v->class }}</td>
												<td id="education_history-{{ $v->id }}" onClick="getEmployee(this.id)">{{ $v->tmt }}</td>
												<td id="education_history-{{ $v->id }}" onClick="getEmployee(this.id)">{{ $v->sk_official }}</td>
												<td id="education_history-{{ $v->id }}" onClick="getEmployee(this.id)">{{ $v->sk_number }}</td>
												<td id="education_history-{{ $v->id }}" onClick="getEmployee(this.id)">{{ $v->sk_date }}</td>
												<td id="education_history-{{ $v->id }}" onClick="getEmployee(this.id)">{{ $v->mk_year }}</td>
												<td id="education_history-{{ $v->id }}" onClick="getEmployee(this.id)">{{ $v->mk_month }}</td>
											</tr>
										@endforeach
										</tbody>
									</table>
