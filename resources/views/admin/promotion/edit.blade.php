								...
								<input type="hidden" name="_method" value="PUT">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
                                            <input type="text" class="form-control" placeholder="Nama Undang-undang" name="name" value="{{ $promotion->name }}" >
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											...
											@if($promotion->file)
											<a href="{{ asset('upload/promotion/'.$promotion->file) }}" target="_blank" class="btn mb-2 mr-1 btn-info">Download File</a>
											@endif
										</div>
									</div>
