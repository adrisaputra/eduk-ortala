						...
						<div class="py-5">
							<div class="rounded border p-10">
								...
								<div class="mb-10">
									...
									<input type="text" class="form-control" placeholder="Nama Jabatan" name="name" value="{{ old('name') }}" />
									@if ($errors->has('name'))
								...
								<div class="mb-10">
									...
									<input type="text" class="form-control" placeholder="Jenis Jabatan" name="type" value="{{ old('type') }}" />
									@if ($errors->has('type'))
										<div class="fv-plugins-message-container invalid-feedback">
