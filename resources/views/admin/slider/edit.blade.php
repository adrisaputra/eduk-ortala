	...
	<div id="kt_content_container" class="container-xxl">
		...
		<div class="card">
			...
			<div class="card-body pt-0">
					...
					<form action="{{ url('/'.Request::segment(1).'/edit/'.Crypt::encrypt($slider->id)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
					{{ csrf_field() }}
						...
						<div class="py-5">
							<div class="rounded border p-10">
								...
								<div class="mb-10">
									...
									@if($slider->image)
										<img src="{{ asset('upload/slider/'.$slider->image) }}" width="150px" height="150px">
									@endif
								</div>
