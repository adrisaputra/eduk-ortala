	...
	<div id="kt_content_container" class="container-xxl">
		...
		<div class="card">
			...
			<div class="card-header border-0 pt-6">
				...
				<div class="card-title">
					...
					<div class="d-flex align-items-center position-relative my-1">
						...
						<input type="text" data-kt-slider-table-filter="search" class="form-control form-control-solid w-300px ps-14 btn-sm " name="search" placeholder="Cari Slider" />
					</div>
					</form>
					<!--end::Search-->
				</div>
				...
				<div class="card-toolbar">
					...
					<div class="d-flex justify-content-end" data-kt-slider-table-toolbar="base">
						...
						@can('tambah-data')
							<a href="{{ url('/'.Request::segment(1).'/create') }}" class="btn btn-primary btn-sm me-2 mb-2"><i class="fa fa-plus"></i>Tambah Slider</a>
						@endcan
			...
			<div class="card-body pt-0">
				...
				<table class="table table-striped table-rounded border border-gray-300 table-row-bordered table-row-gray-300 gy-7 gs-7" id="kt_table_sliders">
					<!--begin::Table head-->
					<thead>
						<!--begin::Table row-->
					...
					<tbody class="text-gray-600 fw-bold">
						...
						<tr>
							...
							<td><img src="{{ asset('upload/slider/'.$v->image) }}" width="150px" height="150px"></td>
							<td>
								@can('ubah-data')
				...
				<!-- PAGINATION -->
				<div style="div-align:right">{{ $slider->appends(Request::only('search'))->links() }}</div>
				</div>
				<!--end::Table-->
			</div>
			<!--end::Card body-->
