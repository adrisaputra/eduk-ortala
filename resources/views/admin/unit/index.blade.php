...
<script>
	...
	function getEmployee(id){
		// Mendapatkan nilai ID dengan menghapus "unit-" dari awal ID
		var unitId = id.replace("unit-", "");
		console.log("ID pegawai yang diklik:", unitId);
	...
	document.addEventListener("click", function(event) {
		...
		if (!clickedElement.matches("td[id^='unit-']") && clickedElement !== editButton) {
