	...
	<div id="kt_content_container" class="container-xxl">
		...
		<div class="card">
			...
			<div class="card-header border-0 pt-6">
				...
				<div class="card-toolbar">
					...
					<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
						...
						@can('tambah-data')
							<a href="{{ url('/'.Request::segment(1).'/create') }}" class="btn btn-primary btn-sm me-2 mb-2"><i class="fa fa-plus"></i>Tambah Menu</a>
						@endcan
			...
			<div class="card-body pt-0">
				...
				<table class="table table-striped table-rounded border border-gray-300 table-row-bordered table-row-gray-300 gy-7 gs-7" id="kt_table_users">
					...
					<tbody class="text-gray-600 fw-bold">
						...
						<tr>
							...
							<td>
								@if($v->link=="#")
									<a href="{{ url('/sub_menu/'.Crypt::encrypt($v->id) ) }}" class="btn btn-sm btn-info"><i class="fa fa-list"></i>Sub Menu</a>
								@endif
								@can('ubah-data')
				...
				<!-- PAGINATION -->
				<div style="div-align:right">{{ $menu->appends(Request::only('search'))->links() }}</div>
				</div>
				<!--end::Table-->
			</div>
			<!--end::Card body-->
