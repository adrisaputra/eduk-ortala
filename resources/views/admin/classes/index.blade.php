...
<script>
	...
	function getEmployee(id){
		// Mendapatkan nilai ID dengan menghapus "classes-" dari awal ID
		var classesId = id.replace("classes-", "");
		console.log("ID pegawai yang diklik:", classesId);
	...
	document.addEventListener("click", function(event) {
		...
		if (!clickedElement.matches("td[id^='classes-']") && clickedElement !== editButton) {
