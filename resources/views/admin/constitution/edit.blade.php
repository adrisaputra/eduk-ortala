                    ...
                    <div id="tableHover" class="col-lg-12 col-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area" style="padding-top: 0px;">
								<form action="{{ url('/'.Request::segment(1).'/edit/'.Crypt::encrypt($constitution->id)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
								{{ csrf_field() }}
								<input type="hidden" name="_method" value="PUT">
		
									<div class="form-group row mb-4">
										<label class="col-xl-3 col-sm-3 col-sm-2 col-form-label">{{ __('Nama Undang-undang') }}  <span class="required" style="color: #dd4b39;">*</span></label>
										<div class="col-xl-9 col-lg-9 col-sm-10">
                                            <input type="text" class="form-control" placeholder="Nama Undang-undang" name="name" value="{{ $constitution->name }}" >
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											...
											<a href="{{ asset('upload/constitution/'.$constitution->file) }}" target="_blank" class="btn mb-2 mr-1 btn-info">Download File</a>
											@endif
										</div>
									</div>
