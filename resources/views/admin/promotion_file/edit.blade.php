                    ...
                    <div id="tableHover" class="col-lg-12 col-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area" style="padding-top: 0px;">
								<form action="{{ url(Request::segment(1).'/edit/'.Request::segment(3).'/'.Crypt::encrypt($promotion_file->id)) }}" method="POST" enctype="multipart/form-data">
								{{ csrf_field() }}
                				<input type="hidden" name="_method" value="PUT">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
                                            <input type="text" class="form-control" placeholder="Nama File" name="name" value="{{ $promotion_file->name }}" >
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											...
											<a href="{{ asset('upload/promotion_file/'.$promotion_file->file) }}" target="_blank" class="btn mb-2 mr-1 btn-info">Download File</a>
											@endif
										</div>
									</div>
