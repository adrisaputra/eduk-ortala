...
<script>
	...
	function getEmployee(id){
		// Mendapatkan nilai ID dengan menghapus "education-" dari awal ID
		var educationId = id.replace("education-", "");
		console.log("ID pegawai yang diklik:", educationId);
		...
		editButton.href = ""+url+"/"+educationId;
	}
	...
	document.addEventListener("click", function(event) {
		...
		if (!clickedElement.matches("td[id^='education-']") && clickedElement !== editButton) {
