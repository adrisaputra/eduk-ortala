                        ...
                        <div class="statbox widget box box-shadow">
							...
							<form action="{{ url('/'.Request::segment(1)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											<input name="old_salary" value="{{ number_format(old('old_salary'), 0, ',', '.') }}" type="text" onkeyup="formatRupiah(this, '.')" class="form-control form-control-sm">
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											<input type="text" class="form-control" name="placeman" id="placeman" value="{{ old('placeman') }}"/>
											</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											<input name="sk_date" id="basicFlatpickr" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Pilih Tanggal">
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											<input type="text" class="form-control" name="sk_number" id="sk_number" value="{{ old('sk_number') }}"/>
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											<input name="start_old_date" id="basicFlatpickr2" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Pilih Tanggal">
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-3 col-lg-3 col-sm-10">
											<input type="text" class="form-control" name="year_old_salary" id="year_old_salary" value="{{ old('year_old_salary') }}" placeholder="Tahun"/>
										</div>
										<div class="col-xl-3 col-lg-3 col-sm-10">
											<input type="text" class="form-control" name="month_old_salary" id="month_old_salary" value="{{ old('month_old_salary') }}" placeholder="Bulan"/>
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											<input name="new_salary" value="{{ number_format(old('new_salary'), 0, ',', '.') }}" type="text" onkeyup="formatRupiah(this, '.')" class="form-control form-control-sm">
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										<label class="col-xl-3 col-sm-3 col-sm-2 col-form-label">{{ __('Masa Kerja') }}</label>
										<div class="col-xl-3 col-lg-3 col-sm-10">
											<input type="text" class="form-control" name="year_new_salary" id="year_new_salary" value="{{ old('year_new_salary') }}" placeholder="Tahun"/>
										</div>
										<div class="col-xl-3 col-lg-3 col-sm-10">
											<input type="text" class="form-control" name="month_new_salary" id="month_new_salary" value="{{ old('month_new_salary') }}" placeholder="Bulan"/>
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											<input name="start_new_date" id="basicFlatpickr3" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Pilih Tanggal">
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10">
											<input name="next_kgb" id="basicFlatpickr4" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Pilih Tanggal">
										</div>
									</div>
