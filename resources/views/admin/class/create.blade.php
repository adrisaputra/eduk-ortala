						...
						<div class="py-5">
							<div class="rounded border p-10">
								...
								<div class="mb-10">
									...
									<input type="text" class="form-control" placeholder="Kode Golongan" name="code" value="{{ old('code') }}" />
									@if ($errors->has('code'))
								...
								<div class="mb-10">
									<label class="form-label required">{{ __('Nama Golongan') }}</label>
									<input type="text" class="form-control" placeholder="Nama Golongan" name="class" value="{{ old('class') }}" />
									@if ($errors->has('class'))
										<div class="fv-plugins-message-container invalid-feedback">
								...
								<div class="mb-10">
									...
									<input type="text" class="form-control" placeholder="Pangkat" name="rank" value="{{ old('rank') }}" />
									@if ($errors->has('rank'))
										<div class="fv-plugins-message-container invalid-feedback">
