							...
							<form action="{{ url('/'.Request::segment(1)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10 col-7">
											<input name="date" id="basicFlatpickr" value="{{ old('date') }}" class="form-control flatpickr flatpickr-input active" type="text" placeholder="Pilih Tanggal">
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10 col-7">
                                            <input type="number" class="form-control" name="employee_amount" value="{{ old('employee_amount') }}" >
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10 col-7">
											<input type="number" class="form-control" name="tl" value="{{ old('tl') }}" >
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10 col-7">
											<input type="number" class="form-control" name="ct" value="{{ old('ct') }}" >
										</div>
									</div>
									...
									<div class="form-group row mb-4">
										...
										<div class="col-xl-9 col-lg-9 col-sm-10 col-7">
											<input type="number" class="form-control" name="th" value="{{ old('th') }}" >
										</div>
									</div>
